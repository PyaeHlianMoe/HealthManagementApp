...
public class ActivityHelp extends AppCompatActivity implements MenuItem.OnMenuItemClickListener{
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_healthmgmt:
                drawerLayout.closeDrawers();
                Intent intenthealth = new Intent(ActivityHelp.this, ActivityHealthMgmt.class);
            ...
            case R.id.menu_logout:
                ...
                Intent intent = new Intent(ActivityHelp.this, ActivityLoginPage.class);
