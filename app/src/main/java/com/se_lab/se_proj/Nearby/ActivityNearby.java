...
public class ActivityNearby extends AppCompatActivity implements MenuItem.OnMenuItemClickListener{
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_healthmgmt:
                drawerLayout.closeDrawers();
                Intent intenthealth = new Intent(ActivityNearby.this, ActivityHealthMgmt.class);
            ...
            case R.id.menu_logout:
                ...
                Intent intent = new Intent(ActivityNearby.this, ActivityLoginPage.class);
