...
public class ActivitySettings extends AppCompatActivity implements MenuItem.OnMenuItemClickListener{
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_healthmgmt:
                drawerLayout.closeDrawers();
                Intent intenthealth = new Intent(com.se_lab.se_proj.ActivitySettings.this, ActivityHealthMgmt.class);
            ...
            case R.id.menu_logout:
                ...
                Intent intent = new Intent(com.se_lab.se_proj.ActivitySettings.this, ActivityLoginPage.class);
