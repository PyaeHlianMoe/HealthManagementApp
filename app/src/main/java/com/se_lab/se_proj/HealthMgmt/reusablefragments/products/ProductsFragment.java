...
import com.se_lab.se_proj.HealthMgmt.browse.BrowseActivity;
...
import com.se_lab.se_proj.databinding.FragmentProductsBinding;
...
public class ProductsFragment extends BaseFragment implements ProductsContract.View {
    ...
    public void sendClickedProduct(Product product) {
        if (getActivity() instanceof ProductsClickedCallback) {
            ...
            throw new RuntimeException("Activity using ProductsFragment must implement ProductsClickedCallback.");
